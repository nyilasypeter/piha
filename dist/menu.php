...
<div class="w3-bar w3-theme">
  <a href="<?= CONTEXT_ROOT . '/welcome.php' ?>" class="w3-bar-item w3-button">Home</a>
  ...
  <a href="<?= CONTEXT_ROOT . '/logout.php' ?>" class="w3-bar-item w3-button w3-theme w3-right">Log out</a>
</div>